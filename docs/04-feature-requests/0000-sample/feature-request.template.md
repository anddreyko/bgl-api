...
> Auto-generated by `/fr/init {TASK-ID}`
> Task: {TASK-ID} from Beads
> Created: {DATE}
...
> {Copy from Beads issue description}
...
- {Dependency 1 - link to Beads issue if applicable}
- {Dependency 2}
...
> From Beads issue acceptance criteria
